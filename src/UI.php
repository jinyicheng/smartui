...
class UI
{
     ...
     * @return string|void
     */
    public static function print_stack_progress($progress_bars, $base_options = [], $return = false)
    {
        $options_map = [
            'tooltip' => [],
    ...
    public static function print_progress($value, $type = '', $options = [], $return = false)
    {
        ...
        $classes[] = implode(' ', $new_options_map['class'] ? $new_options_map['class'] : []);
