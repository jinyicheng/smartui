...
class SmartForm extends UI
{
     ...
     */
    public static function print_field($name, $type = self::FORM_FIELD_INPUT, $properties = [], $options = false, $return = false)
    {
    ...
    private static function _get_field_html($name, $field_type = self::FORM_FIELD_INPUT, $properties = [], $field_html_only = false)
    {
        ...
        switch ($field_type) {
            case self::FORM_FIELD_LABEL:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'label');
            ...
            case self::FORM_FIELD_BLANK:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'content');
            ...
            case self::FORM_FIELD_RATINGS:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'max');
            ...
            case self::FORM_FIELD_TEXTAREA:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'placeholder');
            ...
            case self::FORM_FIELD_SELECT:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'data');
                $data = $new_prop['data'];
                if (!is_array($data)) {
            ...
            case self::FORM_FIELD_FILEINPUT:
                $file_button = self::_get_field_html($name, self::FORM_FIELD_INPUT, array(
                    'type' => 'file',
                    'attr' => array_merge(array('onchange="this.parentNode.nextSibling.value = this.value"'), isset($properties['attr']) ? $properties['attr'] : [])
                ), true);
            ...
            case self::FORM_FIELD_HIDDEN:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'value');
            ...
            case self::FORM_FIELD_RADIO:
                ...
                $new_prop = Util::get_clean_structure($default_prop, $properties, [], 'items');
