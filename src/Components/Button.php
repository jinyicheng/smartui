...
class Button extends UI
{
    ...
    public function print_html($return = false)
    {
        ...
        $icon = Util::get_property_value($structure->icon, array(
            'if_closure' => function ($icon) {
                return Util::run_callback($icon, array($this));
            },
        ...
        $container = Util::get_property_value($structure->container, array(
            'if_closure' => function ($container) {
                return Util::run_callback($container, array($this));
            },
        ...
        $content = Util::get_property_value($structure->content, array(
            'if_closure' => function ($content) {
                return Util::run_callback($content, array($this));
            },
