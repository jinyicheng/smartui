...
class Widget extends UI
{
    ...
    private function _init_structure($user_options, $user_contents)
    {
        ...
        $user_contents_map = array("header" => [], "body" => "", "color" => "");
    ...
    public function print_html($return = false)
    {
        ...
        $attr = Util::get_property_value(
            ...
            array(
                "if_closure" => function ($attr) {
                    return Util::run_callback($attr, array($this));
                }, //if user passes a closure, pass those optional parameters that they can use
                "if_other" => function ($attr) {
                    return $attr;
                }, //just directly return the string for this type of structure item
        ...
        $options = Util::get_property_value(
            $structure->options,
            array(
                "if_closure" => function ($options) {
                    return Util::run_callback($options, array($this));
                },
        ...
        $body = Util::get_property_value(
            $structure->body,
            array(
                "if_closure" => function ($body) {
                    return Util::run_callback($body, array($this));
                },
        ...
        $header = Util::get_property_value(
            $structure->header,
            array(
                "if_closure" => function ($header) use ($body) {
                    return Util::run_callback($body, array($this));
                },
                "if_other" => function ($body) {
                    return $body;
                ...
                "if_array" => function ($body) {
                    ...
                    if (isset($body["toolbar"])) {
                        $toolbar_htm .= Util::get_property_value($body["toolbar"], array(
                            "if_closure" => function ($toolbar) {
                                return Util::run_callback($toolbar, array($this, $toolbar));
                            },
        ...
        $class = Util::get_property_value($structure->class, array(
            "if_closure" => function ($class) {
                return Util::run_callback($class, array($this));
            },
        ...
        $color = Util::get_property_value(
            $structure->color,
            array(
                "if_closure" => function ($color) {
                    return Util::run_callback($color, array($this));
                },
        ...
        $id = Util::get_property_value(
            $structure->id,
            array(
                "if_closure" => function ($id) {
                    return Util::run_callback($id, array($this));
                },
